...
export const newPost = async (req, res) => {
    ...
    try {
        ...
        await newPost.save(); ///we can do that because the name of the collection is already define in the mogoose model
...
export const updatePost = async (req, res) => {
    ...
    const post = req.body; //this is get from the front-end , mothode post

    if (!mongoose.Types.ObjectId.isValid(_id)) ///check if this id is generated by the mongoose.
